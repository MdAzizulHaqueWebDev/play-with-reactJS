...
(0, _axiosDefault.default).get("https://dummyjson.com/users").then((data)=>console.log(data.data)); /**
Uncaught TypeError: Failed to resolve module specifier "axios". Relative references must start with either "/", "./", or "../". */  // console.log(Spinner);
 /**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hPIHA","igcvL"], "igcvL", "parcelRequire9f7e")
